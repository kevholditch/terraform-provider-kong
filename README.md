...
IMPORTANT
------
The provider has been updated to support Kong `v2.X`, there were some breaking changes made between Kong `v1` and `v2`.  To use an Kong `v1` use provider version `v5.X.X`.  That version will no longer be maintained.
